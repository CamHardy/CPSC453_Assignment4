...
vec3 getTriangleNormal(Triangle tri) {
    ...
    normalHit.x = abs(normalHit.x);
    normalHit.y = abs(normalHit.y);
    normalHit.z = abs(normalHit.z);
    return normalize(normalHit);
}
...
void render(){
    ...
    if (mode == 0) {
            mat3 rotatex = mat3(1.0, 0.0, 0.0,
                                0.0, cos(0.25*cos(deg2rad(stimey))), sin(0.25*cos(deg2rad(stimey))),
                                0.0, sin(0.25*cos(deg2rad(stimey))), cos(0.25*cos(deg2rad(stimey))));
            mat3 rotatey = mat3( cos(0.25*sin(deg2rad(stimey))), 0.0, sin(0.25*sin(deg2rad(stimey))),
                                 0.0,          1.0, 0.0,
                                -sin(0.25*sin(deg2rad(stimey))), 0.0, cos(0.25*sin(deg2rad(stimey))));
            camera1Ray.direction *= rotatey;
            camera1Ray.direction *= rotatex;
            FragmentColour = vec4(castRay(camera1Ray), 0.0);
    }
    if (mode == 1) {
        float angle = deg2rad(0.7);
        mat3 rotate2 = mat3( cos(angle), 0.0, sin(angle),
                             0.0,          1.0, 0.0,
                            -sin(angle), 0.0, cos(angle));
        mat3 rotate1 = mat3( cos(-angle), 0.0, sin(-angle),
                             0.0,           1.0, 0.0, 
                            -sin(-angle), 0.0, cos(-angle));
        camera1Ray.direction = normalize(vec3(position1.x, position.y, -1 / scale));
        camera2Ray.direction = normalize(vec3(position2.x, position.y, -1 / scale));
...
void main(void)
{
    ...
    float tt = deg2rad(stimey);

    // back wall
    planes[0] = Plane(vec3(0.0, 0.0, -12.0),
                      vec3(0.0, 0.0, 1.0),
                      vec3(0.3),
                      0, 0.8, 0.3, 16, 1.8);

    spheres[0] = Sphere(vec3(0.0, 0.0, -5.1),
                        0.15,
                        vec3(0.0),
                        0, 0.8, 0.4, 256, 1.8);
    ...
    // bunch o' triangles
    // level 0
    triangles[0] = Triangle(vec3(0.5*sin(tt), 0.5*cos(tt), -6.0-sin(tt)),
                            vec3(0.5*sin(deg2rad(stimey+240)), 0.5*cos(deg2rad(stimey+240)), -6.0-sin(tt)),
                            vec3(0.5*sin(deg2rad(stimey+120)), 0.5*cos(deg2rad(stimey+120)), -6.0-sin(tt)),
                            vec3(1.0, 0.0, 0.0),
                            0, 0.8, 0.3, 64, 1.8);
    
    // level 1
    triangles[1] = Triangle(vec3(0.0, 0.5, -6.0+sin(tt-0.5)),
                            vec3(0.577, -0.5, -6.0+sin(tt-0.5)),
                            vec3(1.154, 0.5, -6.0+sin(tt-0.5)),
                            vec3(1.0, 1.0, 0.0),
                            0, 0.8, 0.3, 64, 1.8);
    
    triangles[2] = Triangle(vec3(0.0, 0.5, -6.0+sin(tt-0.5)),
                            vec3(-1.154, 0.5, -6.0+sin(tt-0.5)),
                            vec3(-0.577, -0.5, -6.0+sin(tt-0.5)),
                            vec3(1.0, 1.0, 0.0),
                            0, 0.8, 0.3, 64, 1.8);  

    triangles[3] = Triangle(vec3(0.0, -1.5, -6.0+sin(tt-0.5)),
                            vec3(0.577, -0.5, -6.0+sin(tt-0.5)),
                            vec3(-0.577, -0.5, -6.0+sin(tt-0.5)),
                            vec3(1.0, 1.0, 0.0),
                            0, 0.8, 0.3, 64, 1.8);  
    ...
    // level 2
    triangles[4] = Triangle(vec3(0.0/sin(tt/2), 0.5/cos(tt/2), -6.0+sin(tt-1.0)),
                            vec3(1.154/sin(tt/2), 0.5/cos(tt/2), -6.0+sin(tt-1.0)),
                            vec3(0.577/sin(tt/2), 1.5/cos(tt/2), -6.0+sin(tt-1.0)),
                            vec3(0.0, 1.0, 0.0),
                            0, 0.8, 0.3, 64, 1.8);
    
    triangles[5] = Triangle(vec3(0.0/sin(tt/2), 0.5/cos(tt/2), -6.0+sin(tt-1.0)),
                            vec3(-0.577/sin(tt/2), 1.5/cos(tt/2), -6.0+sin(tt-1.0)),
                            vec3(-1.154/sin(tt/2), 0.5/cos(tt/2), -6.0+sin(tt-1.0)),
                            vec3(0.0, 1.0, 0.0),
                            0, 0.8, 0.3, 64, 1.8);

    triangles[6] = Triangle(vec3(1.154/sin(tt/2), 0.5/cos(tt/2), -6.0+sin(tt-1.0)),
                            vec3(0.577/sin(tt/2), -0.5/cos(tt/2), -6.0+sin(tt-1.0)),
                            vec3(1.731/sin(tt/2), -0.5/cos(tt/2), -6.0+sin(tt-1.0)),
                            vec3(0.0, 1.0, 0.0),
                            0, 0.8, 0.3, 64, 1.8);    

    triangles[7] = Triangle(vec3(-1.154/sin(tt/2), 0.5/cos(tt/2), -6.0+sin(tt-1.0)),
                            vec3(-1.731/sin(tt/2), -0.5/cos(tt/2), -6.0+sin(tt-1.0)),
                            vec3(-0.577/sin(tt/2), -0.5/cos(tt/2), -6.0+sin(tt-1.0)),
                            vec3(0.0, 1.0, 0.0),
                            0, 0.8, 0.3, 64, 1.8); 

    triangles[8] = Triangle(vec3(0.0/sin(tt/2), -1.5/cos(tt/2), -6.0+sin(tt-1.0)),
                            vec3(1.154/sin(tt/2), -1.5/cos(tt/2), -6.0+sin(tt-1.0)),
                            vec3(0.577/sin(tt/2), -0.5/cos(tt/2), -6.0+sin(tt-1.0)),
                            vec3(0.0, 1.0, 0.0),
                            0, 0.8, 0.3, 64, 1.8);
    
    triangles[9] = Triangle(vec3(0.0/sin(tt/2), -1.5/cos(tt/2), -6.0+sin(tt-1.0)),
                            vec3(-0.577/sin(tt/2), -0.5/cos(tt/2), -6.0+sin(tt-1.0)),
                            vec3(-1.154/sin(tt/2), -1.5/cos(tt/2), -6.0+sin(tt-1.0)),
                            vec3(0.0, 1.0, 0.0),
                            0, 0.8, 0.3, 64, 1.8);
    ...
    // level 3
    triangles[10] = Triangle(vec3(0.0, 0.5, -6.0+sin(tt-1.5)),
                            vec3(0.577, 1.5, -6.0+sin(tt-1.5)),
                            vec3(-0.577, 1.5, -6.0+sin(tt-1.5)),
                            vec3(0.0, 1.0, 1.0),
                            0, 0.8, 0.3, 64, 1.8);

    triangles[11] = Triangle(vec3(1.154, 0.5, -6.0+sin(tt-1.5)),
                            vec3(1.731, 1.5, -6.0+sin(tt-1.5)),
                            vec3(0.577, 1.5, -6.0+sin(tt-1.5)),
                            vec3(0.0, 1.0, 1.0),
                            0, 0.8, 0.3, 64, 1.8);    

    triangles[12] = Triangle(vec3(-1.154, 0.5, -6.0+sin(tt-1.5)),
                            vec3(-0.577, 1.5, -6.0+sin(tt-1.5)),
                            vec3(-1.731, 1.5, -6.0+sin(tt-1.5)),
                            vec3(0.0, 1.0, 1.0),
                            0, 0.8, 0.3, 64, 1.8);

    triangles[13] = Triangle(vec3(1.154, 0.5, -6.0+sin(tt-1.5)),
                            vec3(1.731, -0.5, -6.0+sin(tt-1.5)),
                            vec3(2.308, 0.5, -6.0+sin(tt-1.5)),
                            vec3(0.0, 1.0, 1.0),
                            0, 0.8, 0.3, 64, 1.8);    

    triangles[14] = Triangle(vec3(-1.154, 0.5, -6.0+sin(tt-1.5)),
                            vec3(-2.308, 0.5, -6.0+sin(tt-1.5)),
                            vec3(-1.731, -0.5, -6.0+sin(tt-1.5)),
                            vec3(0.0, 1.0, 1.0),
                            0, 0.8, 0.3, 64, 1.8);

    triangles[15] = Triangle(vec3(1.154, -1.5, -6.0+sin(tt-1.5)),
                            vec3(1.731, -0.5, -6.0+sin(tt-1.5)),
                            vec3(0.577, -0.5, -6.0+sin(tt-1.5)),
                            vec3(0.0, 1.0, 1.0),
                            0, 0.8, 0.3, 64, 1.8);    

    triangles[16] = Triangle(vec3(-1.154, -1.5, -6.0+sin(tt-1.5)),
                            vec3(-0.577, -0.5, -6.0+sin(tt-1.5)),
                            vec3(-1.731, -0.5, -6.0+sin(tt-1.5)),
                            vec3(0.0, 1.0, 1.0),
                            0, 0.8, 0.3, 64, 1.8); 

    triangles[17] = Triangle(vec3(0.0, -1.5, -6.0+sin(tt-1.5)),
                            vec3(0.577, -2.5, -6.0+sin(tt-1.5)),
                            vec3(1.154, -1.5, -6.0+sin(tt-1.5)),
                            vec3(0.0, 1.0, 1.0),
                            0, 0.8, 0.3, 64, 1.8);
    
    triangles[18] = Triangle(vec3(0.0, -1.5, -6.0+sin(tt-1.5)),
                            vec3(-1.154, -1.5, -6.0+sin(tt-1.5)),
                            vec3(-0.577, -2.5, -6.0+sin(tt-1.5)),
                            vec3(0.0, 1.0, 1.0),
                            0, 0.8, 0.3, 64, 1.8);
    ...
    // level 4
    triangles[19] = Triangle(vec3(0.0*sin(tt), 2.5*cos(tt), -6.0+sin(tt-2.0)),
                            vec3(-0.577*sin(tt), 1.5*cos(tt), -6.0+sin(tt-2.0)),
                            vec3(0.577*sin(tt), 1.5*cos(tt), -6.0+sin(tt-2.0)),
                            vec3(0.0, 0.0, 1.0),
                            0, 0.8, 0.3, 64, 1.8);

    triangles[20] = Triangle(vec3(1.154*sin(tt), 2.5*cos(tt), -6.0+sin(tt-2.0)),
                            vec3(0.577*sin(tt), 1.5*cos(tt), -6.0+sin(tt-2.0)),
                            vec3(1.731*sin(tt), 1.5*cos(tt), -6.0+sin(tt-2.0)),
                            vec3(0.0, 0.0, 1.0),
                            0, 0.8, 0.3, 64, 1.8);    

    triangles[21] = Triangle(vec3(-1.154*sin(tt), 2.5*cos(tt), -6.0+sin(tt-2.0)),
                            vec3(-1.731*sin(tt), 1.5*cos(tt), -6.0+sin(tt-2.0)),
                            vec3(-0.577*sin(tt), 1.5*cos(tt), -6.0+sin(tt-2.0)),
                            vec3(0.0, 0.0, 1.0),
                            0, 0.8, 0.3, 64, 1.8);

    triangles[22] = Triangle(vec3(1.154*sin(tt), 0.5*cos(tt), -6.0+sin(tt-2.0)),
                            vec3(2.308*sin(tt), 0.5*cos(tt), -6.0+sin(tt-2.0)),
                            vec3(1.731*sin(tt), 1.5*cos(tt), -6.0+sin(tt-2.0)),
                            vec3(0.0, 0.0, 1.0),
                            0, 0.8, 0.3, 64, 1.8);    

    triangles[23] = Triangle(vec3(-1.154*sin(tt), 0.5*cos(tt), -6.0+sin(tt-2.0)),
                            vec3(-1.731*sin(tt), 1.5*cos(tt), -6.0+sin(tt-2.0)),
                            vec3(-2.308*sin(tt), 0.5*cos(tt), -6.0+sin(tt-2.0)),
                            vec3(0.0, 0.0, 1.0),
                            0, 0.8, 0.3, 64, 1.8);

    triangles[24] = Triangle(vec3(2.308*sin(tt), 0.5*cos(tt), -6.0+sin(tt-2.0)),
                            vec3(1.731*sin(tt), -0.5*cos(tt), -6.0+sin(tt-2.0)),
                            vec3(2.885*sin(tt), -0.5*cos(tt), -6.0+sin(tt-2.0)),
                            vec3(0.0, 0.0, 1.0),
                            0, 0.8, 0.3, 64, 1.8);    

    triangles[25] = Triangle(vec3(-2.308*sin(tt), 0.5*cos(tt), -6.0+sin(tt-2.0)),
                            vec3(-2.885*sin(tt), -0.5*cos(tt), -6.0+sin(tt-2.0)),
                            vec3(-1.731*sin(tt), -0.5*cos(tt), -6.0+sin(tt-2.0)),
                            vec3(0.0, 0.0, 1.0),
                            0, 0.8, 0.3, 64, 1.8); 

    triangles[26] = Triangle(vec3(1.154*sin(tt), -1.5*cos(tt), -6.0+sin(tt-2.0)),
                            vec3(2.308*sin(tt), -1.5*cos(tt), -6.0+sin(tt-2.0)),
                            vec3(1.731*sin(tt), -0.5*cos(tt), -6.0+sin(tt-2.0)),
                            vec3(0.0, 0.0, 1.0),
                            0, 0.8, 0.3, 64, 1.8);    

    triangles[27] = Triangle(vec3(-1.154*sin(tt), -1.5*cos(tt), -6.0+sin(tt-2.0)),
                            vec3(-1.731*sin(tt), -0.5*cos(tt), -6.0+sin(tt-2.0)),
                            vec3(-2.308*sin(tt), -1.5*cos(tt), -6.0+sin(tt-2.0)),
                            vec3(0.0, 0.0, 1.0),
                            0, 0.8, 0.3, 64, 1.8);

    triangles[28] = Triangle(vec3(0.0*sin(tt), -1.5*cos(tt), -6.0+sin(tt-2.0)),
                            vec3(-0.577*sin(tt), -2.5*cos(tt), -6.0+sin(tt-2.0)),
                            vec3(0.577*sin(tt), -2.5*cos(tt), -6.0+sin(tt-2.0)),
                            vec3(0.0, 0.0, 1.0),
                            0, 0.8, 0.3, 64, 1.8);

    triangles[29] = Triangle(vec3(1.154*sin(tt), -1.5*cos(tt), -6.0+sin(tt-2.0)),
                            vec3(0.577*sin(tt), -2.5*cos(tt), -6.0+sin(tt-2.0)),
                            vec3(1.731*sin(tt), -2.5*cos(tt), -6.0+sin(tt-2.0)),
                            vec3(0.0, 0.0, 1.0),
                            0, 0.8, 0.3, 64, 1.8);    

    triangles[30] = Triangle(vec3(-1.154*sin(tt), -1.5*cos(tt), -6.0+sin(tt-2.0)),
                            vec3(-1.731*sin(tt), -2.5*cos(tt), -6.0+sin(tt-2.0)),
                            vec3(-0.577*sin(tt), -2.5*cos(tt), -6.0+sin(tt-2.0)),
                            vec3(0.0, 0.0, 1.0),
                            0, 0.8, 0.3, 64, 1.8);  
    ...
    // lights
    pLights[0] = PointLight(vec3(0.0),
                            0.8,
                            vec3(sin(tt), cos(tt), tan(tt)));
